...
$incoming_id = isset($_POST['iduser']) ? $_POST["iduser"] : '';
    ...
    if (in_array($img_ext, $extensions) === true) {
        ...
        if (in_array($img_type, $types) === true) {
            ...
            if (move_uploaded_file($tmp_name, "file/" . $new_img_name)) {
                ...
                $insert_query = mysqli_query($conn, "INSERT INTO message (to_id, from_id, msg, id_type, status, hidden, create_at)
                    VALUES ($incoming_id, $outgoing_id, '$new_img_name',2,0,0,'{$today}')");
                header("location:../index.php?id_user=$incoming_id");
            } else {
